...
public class VariableSelectionPropertiesDTO implements Serializable {
	...
	private Map<String, Double> columnPvalues;
	private Map<String, Double> coeffList;
	private List<String> modifiedCoefList;
	private double coefMinValue;
	private Map<String, Double> modifiedCoefDetails;
	private List<String> vifValuesFinalList;
	private List<String[]> listOfValues;
	private double[][] x;
	private double[] y;
	private Map<String, Integer> headersInformation;
	private List<String> errorFreeList;
	private int noOfLines;
	private Map<String, Double> vifValues;

...
public class NetworkCommunicator {   
	...
	static {
		...
		try {
			...
			sc = new JavaSparkContext(Constants.HIVE_CLIENT_NAME, Constants.HIVE_APP_NAME);
			...
			//Creating a hive context object connection by using java spark context object
			hiveContext = new org.apache.spark.sql.hive.HiveContext(
			      ...
			      e.printStackTrace();
			      System.out.println("Failed to connect,Contact  ");
		        }
	       }
